...
import com.alexzhli.bilibili.dao.VideoDao;
...
import com.alexzhli.bilibili.service.util.ImageUtil;
...
import com.alexzhli.bilibili.service.util.IpUtil;
...
public class VideoService {
    ...
    // 每隔多少帧进行一次截取
    private static final int FRAME_NO = 32;
    ...
    public void addVideos(Video video) {
        ...
        // 此处处理有一些问题，当添加视频的时候，并没有添加tagList就会回滚出错
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        // 先把视频现在到应用服务器的本地进行处理
        com.alexzhli.bilibili.domain.File file = fileService.getFileByMd5(fileMd5);
        ...
        for(int i=1; i<= ffLength; i ++){
            ...
            // 有些视频帧数会很大，这个时候不需要截取每一帧，可以截取某个频率的画面
            if(count == i){
                if(frame == null){
